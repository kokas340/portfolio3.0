...
const Projects = () => {
  ...
  return (
    <>
      <div className="h-28">
        <p className=' text-slate-100 text-6xl font-bold text-center pb-12 pt-12'>Projects</p>
      </div>
        ...
        >
          <a className='z-50' href="https://github.com/kokas340/chess" target="_blank">
            ...
            <div className="pt-4">
              ...
              <p className='text-slate-100 text-2xl  text-center pt-9 px-7'>I took this on as a challenge, not being allowed to use any chess pre-built libraries.</p>
            </div>
          </a>
        ...
        <div class="col-span-2 pt-12 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300">
          <a className='z-50' href="https://github.com/kokas340/FirebaseChat" target="_blank">
            ...
            <div className="pt-4">
              ...
              <p className='text-slate-100 text-2xl  text-center px-7 pt-9'>I had too much time on my hands and decided to create a chat app with React Native and Firebase.</p>
            </div>
          </a>
        </div>
        <div class="col-span-2 pt-12 transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110  duration-300">
          <div>
            <ProjectMesh mesh={"chess"} canvas={"webglChess2"}></ProjectMesh>
